    ...
    <div ref={containerRef} className="w-full bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[600px] relative group">
      <div className="p-5 border-b border-slate-200 bg-slate-50 flex justify-between items-center flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
           <div className="flex gap-3 mr-4 border-r border-slate-300 pr-4 hidden sm:flex"><div className="flex items-center gap-1.5 text-[10px] text-slate-700 font-bold"><span className="w-2 h-2 rounded-full bg-green-500 shadow-sm"></span> Scan</div><div className="flex items-center gap-1.5 text-[10px] text-slate-700 font-bold"><span className="w-2 h-2 rounded-full bg-red-500 shadow-sm"></span> Shuffle</div><div className="flex items-center gap-1.5 text-[10px] text-slate-700 font-bold"><span className="w-2 h-2 rounded-full bg-cyan-500 shadow-sm"></span> Transform</div></div>
           <div className="flex bg-white rounded-lg border border-slate-200 shadow-sm"><button onClick={() => handleZoom(1.2)} className="p-2 hover:bg-slate-50 text-slate-600 hover:text-slate-900 transition-colors"><ZoomIn className="w-4 h-4" /></button><button onClick={() => handleZoom(0.8)} className="p-2 hover:bg-slate-50 text-slate-600 hover:text-slate-900 border-l border-slate-200 transition-colors"><ZoomOut className="w-4 h-4" /></button></div>
        </div>
      </div>
      <div className="flex-1 relative overflow-hidden bg-white"><div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#64748b 1.5px, transparent 1.5px)', backgroundSize: '20px 20px' }}></div><svg ref={svgRef} className="w-full h-full block relative z-10"></svg></div>
    </div>
  );
};
