      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 relative z-10">
          <div className="group">
            ...
            <div className="flex items-center border border-slate-200 rounded-xl px-4 py-3 bg-slate-50 focus-within:ring-2 focus-within:ring-orange-500/20 focus-within:border-orange-500 transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
           <div className="bg-white p-6 rounded-2xl border border-slate-200 hover:bg-slate-50 transition-colors shadow-sm group">
           ...
           <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100 hover:bg-emerald-100 transition-colors shadow-sm group">
