          ...
          <div key={idx} className="bg-white/50 backdrop-blur-3xl rounded-3xl shadow-lg border border-white/60 overflow-hidden group hover:border-blue-300 transition-all relative ring-1 ring-white/40">
            ...
            <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 text-xs font-mono text-blue-800">
                    {map.callStack.map((func, i) => (
                      <React.Fragment key={i}>
                        <span className="bg-white/60 px-2 py-1 rounded border border-blue-200">{func}</span>
              ...
              {map.dependencies && map.dependencies.length > 0 && (
                <div className="mb-4 p-3 bg-purple-50/50 rounded-lg border border-purple-200/50">
